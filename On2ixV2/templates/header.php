	...
	<!-- Navigation -->
		<nav class="navbar navbar-expand-lg navbar-light maNav">
			...
			<div class="collapse navbar-collapse" id="navbarToggler">
			      ...
			      <li class="nav-item">
			        <a class="nav-link lien" href="index.php?view=bague">Bagues</a>
			      </li>
						<li class="nav-item">
			      ...
			      <li class="nav-item">
			        <a class="nav-link" href="#">Montres</a>
						...
						<li class="nav-item">
			        <a class="nav-link" href="index.php?view=surMesure">Sur mesure</a>
			      </li>
						<li class="nav-item">
			        <a class="nav-link" href="index.php?view=serviceClient">Service client</a>
			      </li>
